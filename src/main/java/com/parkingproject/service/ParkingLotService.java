...
import com.parkingproject.exception.ParkingLotException;
import com.parkingproject.model.Car;
import com.parkingproject.model.ParkingLot;
import com.parkingproject.model.Slot;
import com.parkingproject.model.parking.strategy.ParkingStrategy;
 ...
 */	
  ...
  public List<Slot> getSlotsForDriverAge(final int age) {
	    ...
	    return occupiedSlots.stream()
	        .filter(slot -> slot.getParkedCar().getAge()==age)
